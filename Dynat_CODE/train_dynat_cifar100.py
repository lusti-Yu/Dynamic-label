...
parser.add_argument('--model-dir', default='./model-cifar10-wideResNet_kl_oneadvkl',
...
def train(args, model, model_teacher, device, train_loader, optimizer, epoch):
    ...
    for batch_idx, (data, target) in enumerate(train_loader):
        ...
        loss = dynat_loss(model=model, model_teacher=model_teacher,
                           x_natural=data,
                           y=target,
                           optimizer=optimizer,
